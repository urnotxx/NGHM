package com.zzx.haoniu.hzcxdj.websocket;
...
import com.zzx.haoniu.hzcxdj.entity.WebSocketInfo;
            ...
            if (info != null) {
                if (info.getContent().getTitle() == 1) {
                    if (info.getType() == 3) {//下单推送订单给司机
                        CommonEventBusEnity enity = new CommonEventBusEnity("djgrabOrderInfo", null);
