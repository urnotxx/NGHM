package com.zzx.haoniu.app_nghmuser.overlay;
...
//                getShowRouteZoom()));
        ...
        boundsBuilder.include(startPoint);//把所有点都include进去
        boundsBuilder.include(endPoint);//把所有点都include进去
        mAMap.moveCamera(CameraUpdateFactory.newLatLngBounds(boundsBuilder.build(), 250));
    }
    ...
    protected int getDriveColor() {
        return Color.parseColor("#76C94B");
    }
