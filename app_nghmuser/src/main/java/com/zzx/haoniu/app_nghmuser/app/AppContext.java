package com.zzx.haoniu.app_nghmuser.app;
...
import com.zzx.haoniu.app_nghmuser.storage.Storage;
...
public class AppContext extends SelfAppContext {
    ...
    public boolean checkCallBackUser() {
        if (getLoginCallback().getLoginId() == null) {
            return false;
        } else {
            return true;
        }
     ...
     * @since 2.5.0
     */
    private List<String> findDeniedPermissions(Context contexts, String[] permissions) {
        List<String> needRequestPermissonList = new ArrayList<String>();
        for (String perm : permissions) {
            if (ContextCompat.checkSelfPermission(this,
                    perm) != PackageManager.PERMISSION_GRANTED
                    || ActivityCompat.shouldShowRequestPermissionRationale(
                    (Activity) contexts, perm)) {
