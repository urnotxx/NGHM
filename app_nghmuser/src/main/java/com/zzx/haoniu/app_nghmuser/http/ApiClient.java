...
public class ApiClient {
    ...
    public static void requestNetHandle(final Context context, final String url, String log, Map<String, Object> mapP, final ResultListener listener, boolean isCache) {
        ...
        try {
            ...
            OKHttpUtils.getInstance().addHeader("appType", "2");
...
//                        ServerData serverData = gson.fromJson(response, new TypeToken<ServerData>() {
//                        }.getType());
                        if (null != serverData) {
                            if (serverData.getStatus().equals("OK")) {
                                ...
                                CommonEventBusEnity busEnity = new CommonEventBusEnity("unLogInUser", null);
