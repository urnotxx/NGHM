package com.zzx.haoniu.nghmtaxi.utils;
 ...
 */
public class TTSController_1 implements SynthesizerListener {

    /**
     * 请替换您自己申请的ID。
     */
    private final String appId = "58eeea62";

    public static TTSController_1 ttsManager;
    ...
    private TTSController_1(Context context) {
    ...
    public static TTSController_1 getInstance(Context context) {
        if (ttsManager == null) {
            ttsManager = new TTSController_1(context);
        }
        return ttsManager;
    }
