...
//            Log.d(TAG, "[MyReceiver] 接收Registration Id : " + regId);
            ...
            if (extra != null && !StringUtils.isEmpty(extra)) {
                ...
                if (jpushInfo != null && jpushInfo.getTitle().equals("1") && jpushInfo.getContent() != null &&
                        !StringUtils.isEmpty(jpushInfo.getContent())) {//下单推送订单给司机   1
                    CommonEventBusEnity commonEventBusEnity = new CommonEventBusEnity("taxigrabOrderInfo", null);
                ...
                } else if (jpushInfo != null && jpushInfo.getTitle().equals("5") && jpushInfo.getContent() != null) {
                ...
                } else if (jpushInfo != null && jpushInfo.getTitle().equals("4") && jpushInfo.getContent() != null) {//推送给司机  订单已经被销毁
